...
<div class="aside aside-left d-flex flex-column " id="kt_aside">
    ...
    <div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-4 py-lg-8">
        ...
        <a href="{{ route('dashboard') }}">
            <img alt="Logo" src="{{ asset('media/client-logos/Logo-client-png.png') }}" class="max-h-50px" />
        </a>
    ...
    <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pt-7">
        ...
        <ul class="nav flex-column">
            ...
            @if (Auth::user()->role_id == 1)
                ...
                <!--begin::Item-->
                <li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body"
                    data-boundary="window" title="Kritik dan Saran">
                    <a href="{{ route('kritikPageAdmin') }}"
                        class="nav-link btn btn-icon btn-clean btn-icon-white btn-lg {{ set_active('kritikPageAdmin') }}"
                        role="tab">
