                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                <div class="card-title">
                                    <h3 class="card-label text-uppercase text-dark-75">Buat Banner
                                    </h3>
                                </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="card card-custom gutter-b card-stretch">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-xl-12">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container has-success">
                                                            ...
                                                            <input id="bundleName" type="text"
                                                                ...
                                                                name="banner_name" placeholder="Enter" required>
                                                ...
                                                {{-- Gambar --}}
                                                <div class="form-group">
                                                    <label for="">Gambar Banner</label><br>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mt-6 mb-0">
                                                    <div class="col-lg-10 mb-0">
                                                        <label for="Nama Items">Product</label>
                                                    </div>
                                                </div>
