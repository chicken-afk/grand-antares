...
@section('script')
    ...
    <script src="{{ asset('js/pages/custom/wizard/wizard-1-edit.js') }}"></script>
    <script src="{{ asset('js/pages/crud/file-upload/dropzonejs.js') }}"></script>
    <script src="{{ asset('js/editproduct.js') . '?v=' . time() }}"></script>
@endsection
@section('content')
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                <div class="card-title">
                                    <h3 class="card-label text-uppercase">Edit Product
                                    </h3>
                                </div>
                            </div>
                                        ...
                                        <div class="col-xl-12 col-xxl-7">
                                            ...
                                            <form method="POST" action="{{ route('postEditProduct') }}"
                                                ...
                                                <div class="pb-5" data-wizard-type="step-content"
                                                    ...
                                                    <h3 class="mb-10 font-weight-bold text-dark">Detail Produk</h3>
                                                    <div class="row mb-6 text-center">
                                                        <div class="col-lg-12">
                                                            <img class="max-h-250px"
                                                                src="{{ asset($row['product']->product_image) }}"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            ...
                                                            <div class="form-group fv-plugins-icon-container has-success">
                                                                ...
                                                                <input id="productName" type="text"
                                                                    ...
                                                                    value="{{ $row['product']->active_product_name }}">
                                                        ...
                                                        <div class="col-xl-6">
                                                            ...
                                                            <div class="form-group fv-plugins-icon-container has-success">
                                                                ...
                                                                <input style="text-transform:uppercase" type="text"
                                                                    ...
                                                                    value="{{ $row['product']->sku }}" disabled>
                                                                <div class="fv-plugins-message-container"></div>
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group fv-plugins-icon-container has-success">
                                                                ...
                                                                <select name="category"
                                                                    ...
                                                                    @foreach ($row['categories'] as $key => $value)
                                                                        <option
                                                                            {{ $row['product']->category_id == $value->id ? 'selected' : '' }}
                                                                            {{-- selected="{{ $row['product']->category_id == $value->id ? 'selected' : '' }}" --}}
                                                                            value="{{ $value->id }}">
                                                        ...
                                                        <div class="col-xl-6" id="subCategories">
                                                            @if ($row['product']->sub_category_id != null)
                                                                <!--begin::Select-->
                                                                <div
                                                                    ...
                                                                    <select name="subCategoryId"
                                                                        ...
                                                                        @foreach ($row['sub_categories'] as $key => $value)
                                                                            <option
                                                                                {{ $row['product']->sub_category_id == $value->id ? 'selected' : '' }}
                                                                                {{-- selected="{{ $row['product']->category_id == $value->id ? 'selected' : '' }}" --}}
                                                                                value="{{ $value->id }}">
                                                        ...
                                                        <div class="col-xl-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    id="productPrice"
                                                                    value="{{ $row['product']->price_display }}">
                                                                <span class="form-text text-muted">Please enter your
                                                                    Price.</span>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    id="productPriceRestaurant"
                                                                    value="{{ $row['product']->price_display_restaurant }}">
                                                                <span class="form-text text-muted">Please enter your
                                                                    Resto Price.</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="">Upload Gambar Produk Untuk Mengubah gambar
                                                            (abaikan jika gambar tidak ingin diubah)</label><br>
                                                                ...
                                                                <div class="col-xl-4">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $v->varian_price_restaurant }}">
                                                                        <span class="form-text text-muted">Masukan harga
                                                                            varian
                                                                ...
                                                                <div class="col-xl-4">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $v->topping_price_restaurant }}">
                                                                        <span class="form-text text-muted">Masukan Harga
                                                                            Toping
                                                                            Restaurant</span>
                                                                        <div class="fv-plugins-message-container"></div>
