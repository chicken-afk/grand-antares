                                                ...
                                                <table class="table table-separate table-head-custom table-checkable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="p-0 min-w-200px">Icon</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($row['datas'] as $key => $value)
                                                            <tr>
                                                                ...
                                                                <td class="">
                                                                    <img class="icon thumbnail max-h-100px"
                                                                        src="{{ $value->category_image }}" alt="">
                                                                </td>
                                                                <td class="">
                                                                    <span
                                                                ...
                                                                <td class="">
                                                                    @if ($value->is_active == 1)
                                                                        <a
                                                                            href="{{ route('editStatusCategory', $value->id) }}">
                                                                            <span
                                    ...
                                    <div class="form-group mb-8">
                                        <div class="form-group">
                                            ...
                                            <span class="form-text text-muted">Kategori produk, contoh : "Makanan",
                                                "Minuman",
                                                "Desert</span>
                                            <label>Icon Kategori<span class="text-danger">*</span></label>
                                            <input type="file" class="form-control" name="category_image"
                                                placeholder="Enter Icon Category" accept=".png, .jpg, .jpeg, .svg"
                                                required />
                                            <span class="form-text text-muted">Icon Kategori</span>
                                        </div>
                                    </div>
                                    <!--end::Form-->
                                </div>
