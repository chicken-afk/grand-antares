...
<head>
    <base href="../../../">
    <meta charset="utf-8" />
    <title>Error Page | Warung Aceh Bang Ari</title>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('media/client-logos/logo.png') }}">
</head>
<!--end::Head-->
<!--begin::Body-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="error error-4 d-flex flex-row-fluid bgi-size-cover bgi-position-center"
            style="background-image: url(/media/error/bg4.jpg);">
            <!--begin::Content-->
            <div
